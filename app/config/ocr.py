...
class OCRConfig:
    ...
    ENABLE_SEAL_RECOGNITION = _to_bool(
        os.getenv("PADDLE_OCR_ENABLE_SEAL_RECOGNITION"), True
    )
    EXCLUDE_SEAL_TEXT = _to_bool(
        os.getenv("PADDLE_OCR_EXCLUDE_SEAL_TEXT"), True
    )
